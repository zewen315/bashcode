...
export function ProblemSolution({ problem }: { problem: ProblemDetail }) {
  return (
    <div className="px-5 py-4">
      ...
      <p className="mb-1.5 text-xs font-medium text-muted-foreground">solution.sh</p>
      <pre className="overflow-x-auto rounded bg-muted p-3 font-mono text-xs whitespace-pre">
